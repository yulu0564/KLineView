...
public abstract class BaseNoScollTimeLineView extends BaseStockView {
    ...
    public BaseNoScollTimeLineView(Context context) {
        this(context, null);
    }

    public BaseNoScollTimeLineView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BaseNoScollTimeLineView(Context context, AttributeSet attrs, int defStyle) {
...
//    }
    ...
    public Paint mTimeLinePaint;  //画笔
